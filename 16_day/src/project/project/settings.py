...
SECRET_KEY = 'django-insecure-x0!g&3v^86de-e1!e&dxzqhk(om6ja+&6l@1=fqn$2)(2(%!$o'
...
INSTALLED_APPS = [
    ...
    'base.apps.BaseConfig', # Declaro mi app base para que django la conozca y sepa su existencia
]
